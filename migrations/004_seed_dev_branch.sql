...
VALUES 
  ('11111111-1111-1111-1111-111111111111', 'a0000000-0000-0000-0000-000000000001', 'University of Manchester', NULL, true, 5000),
  ('11111111-1111-1111-1111-111111111112', 'a0000000-0000-0000-0000-000000000001', 'University of Birmingham', NULL, false, 2500),
  ('11111111-1111-1111-1111-111111111113', 'a0000000-0000-0000-0000-000000000001', 'University of Leeds', NULL, true, 3000)
ON CONFLICT (id) DO NOTHING;

-- Demo University Organizations (their own internal departments)
INSERT INTO organization (id, tenant_id, name, purchase_order_enabled, training_fund_balance)
VALUES 
  ('22222222-2222-2222-2222-222222222221', 'b0000000-0000-0000-0000-000000000002', 'Business School', false, 1000),
  ('22222222-2222-2222-2222-222222222222', 'b0000000-0000-0000-0000-000000000002', 'Engineering Faculty', true, 2000)
ON CONFLICT (id) DO NOTHING;

-- Pro Association Organizations
INSERT INTO organization (id, tenant_id, name, purchase_order_enabled, training_fund_balance)
VALUES 
  ('33333333-3333-3333-3333-333333333331', 'c0000000-0000-0000-0000-000000000003', 'Corporate Member A', true, 10000),
  ('33333333-3333-3333-3333-333333333332', 'c0000000-0000-0000-0000-000000000003', 'Corporate Member B', false, 0)
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ('m1111111-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'john.smith@manchester.ac.uk', 'John', 'Smith', '11111111-1111-1111-1111-111111111111', 'aaaa1111-0000-0000-0000-000000000001', true, true),
  ('m1111111-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'jane.doe@birmingham.ac.uk', 'Jane', 'Doe', '11111111-1111-1111-1111-111111111112', 'aaaa1111-0000-0000-0000-000000000001', true, true),
  ('m1111111-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'admin@agcas.org.uk', 'AGCAS', 'Admin', '11111111-1111-1111-1111-111111111111', 'aaaa1111-0000-0000-0000-000000000002', true, false),
  ('m1111111-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'sarah.jones@leeds.ac.uk', 'Sarah', 'Jones', '11111111-1111-1111-1111-111111111113', 'aaaa1111-0000-0000-0000-000000000003', true, true)
ON CONFLICT (id) DO NOTHING;

-- Demo University Members
INSERT INTO member (id, tenant_id, email, first_name, last_name, organization_id, role_id, login_enabled, show_in_directory)
VALUES 
  ('m2222222-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 'student1@demo-university.ac.uk', 'Alex', 'Student', '22222222-2222-2222-2222-222222222221', 'bbbb2222-0000-0000-0000-000000000001', true, true),
  ('m2222222-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'advisor@demo-university.ac.uk', 'Carol', 'Advisor', '22222222-2222-2222-2222-222222222221', 'bbbb2222-0000-0000-0000-000000000003', true, true)
ON CONFLICT (id) DO NOTHING;

-- Pro Association Members
INSERT INTO member (id, tenant_id, email, first_name, last_name, organization_id, role_id, login_enabled, show_in_directory)
VALUES 
  ('m3333333-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000003', 'member@corpA.com', 'Bob', 'Corporate', '33333333-3333-3333-3333-333333333331', 'cccc3333-0000-0000-0000-000000000001', true, true)
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ('bk111111-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'e1111111-0000-0000-0000-000000000001', 'm1111111-0000-0000-0000-000000000001', 'john.smith@manchester.ac.uk', 'John', 'Smith', 350, 'confirmed', 'AGCAS-2025-0001'),
  ('bk111111-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'e1111111-0000-0000-0000-000000000002', 'm1111111-0000-0000-0000-000000000002', 'jane.doe@birmingham.ac.uk', 'Jane', 'Doe', 0, 'confirmed', 'AGCAS-2025-0002'),
  ('bk111111-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'e1111111-0000-0000-0000-000000000001', 'm1111111-0000-0000-0000-000000000004', 'sarah.jones@leeds.ac.uk', 'Sarah', 'Jones', 350, 'pending', 'AGCAS-2025-0003')
ON CONFLICT (id) DO NOTHING;

-- Demo University Bookings
INSERT INTO booking (id, tenant_id, event_id, member_id, attendee_email, attendee_first_name, attendee_last_name, ticket_price, status, booking_reference)
VALUES 
  ('bk222222-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 'e2222222-0000-0000-0000-000000000001', 'm2222222-0000-0000-0000-000000000001', 'student1@demo-university.ac.uk', 'Alex', 'Student', 0, 'confirmed', 'DEMO-2025-0001')
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ('p1111111-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Unpacked Series Subscription', 'Annual subscription to all Unpacked webinars', 'Unpacked Series', 500, true, 'subscription'),
  ('p1111111-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'Conference Bundle', 'Discounted conference package', 'Conference', 300, true, 'bundle')
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ('bp111111-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Welcome to the New AGCAS Portal', 'welcome-new-portal', 'AGCAS Team', 'Introducing our redesigned member portal with new features and improved navigation.', '<p>We are excited to announce the launch of our new member portal...</p>', 'published', NOW() - INTERVAL '7 days'),
  ('bp111111-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'Top 10 Career Trends for 2025', 'career-trends-2025', 'Dr. James Wilson', 'A look at emerging trends in graduate employment and careers guidance.', '<p>As we move into 2025, several key trends are shaping the careers landscape...</p>', 'published', NOW() - INTERVAL '3 days')
ON CONFLICT (id) DO NOTHING;

-- Demo University Blog Posts
INSERT INTO blog_post (id, tenant_id, title, slug, author_name, summary, content, status, published_date)
VALUES 
  ('bp222222-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 'Preparing for Graduate Recruitment Season', 'grad-recruitment-season', 'Careers Team', 'Tips for making the most of employer events this term.', '<p>With recruitment season approaching, here are our top tips...</p>', 'published', NOW() - INTERVAL '5 days')
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ('r1111111-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Employability Framework Guide', 'Comprehensive guide to embedding employability', 'document', 'https://example.com/guide.pdf', false, 'published'),
  ('r1111111-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'AI Tools Directory', 'Curated list of AI tools for careers professionals', 'link', 'https://example.com/ai-tools', true, 'published')
ON CONFLICT (id) DO NOTHING;
...
VALUES 
  ('nav11111-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Home', '/', 'header', 1, true, 'internal'),
  ('nav11111-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'Events', '/events', 'header', 2, true, 'internal'),
  ('nav11111-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'Resources', '/resources', 'header', 3, true, 'internal'),
  ('nav11111-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'Blog', '/blog', 'header', 4, true, 'internal')
ON CONFLICT (id) DO NOTHING;

-- Demo University Navigation
INSERT INTO navigation_item (id, tenant_id, title, url, location, display_order, is_active, link_type)
VALUES 
  ('nav22222-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 'Dashboard', '/', 'header', 1, true, 'internal'),
  ('nav22222-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'Careers Fair', '/events', 'header', 2, true, 'internal'),
  ('nav22222-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000002', 'Appointments', '/appointments', 'header', 3, true, 'internal')
ON CONFLICT (id) DO NOTHING;
